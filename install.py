            ...
            files=[('bin/user',
                   ...
                   ('skins/StandardPower',
                    ['skins/StandardPower/favicon.ico',
                     ...
                     'skins/StandardPower/Summary-YYYY-MM.txt.tmpl',
                     'skins/StandardPower/week.html.tmpl',
                     'skins/StandardPower/weewx.css',
                     'skins/StandardPower/year.html.tmpl']),
                   ('skins/Power',
                    ['skins/Power/current.inc',
                     'skins/Power/favicon.ico',
                     'skins/Power/hilo.inc',
                     'skins/Power/identifier.inc',
                     'skins/Power/index.html.tmpl',
                     'skins/Power/power.css',
                     'skins/Power/power.js',
                     'skins/Power/skin.conf',
                     'skins/Power/statistics.html.tmpl',
                     'skins/Power/statistics.inc',
                     'skins/Power/tabular.html.tmpl',
                     'skins/Power/titlebar.inc']),                   
                   ('skins/Power/POWER',
                    ['skins/Power/POWER/POWER-YYYY.txt.tmpl'],
                    ['skins/Power/POWER/POWER-YYYY-MM.txt.tmpl']),
                   ]
        )
